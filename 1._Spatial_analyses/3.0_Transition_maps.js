...
var cover = ee.ImageCollection('projects/ee-seeg-br-c9/assets/v1/2_1_Mask_stable').aside(print);
...
// Please ignore the Task to export this last non-existing year pair (eg. 2021_2022)
  ...
  "assetId": 'projects/ee-seeg-br-c9/assets/v1/3_0_Transition_maps/SEEG_Transitions_' + (parseInt(year))+'_'+(parseInt(year)+1), // Enter the address and name 'project/seeg/col9/v1'of the Asset to be exported
  "scale": 30,
  "pyramidingPolicy": {
      '.default': 'mode'
  },
